...
x = x - 1;
y = y - 1;
set(hObject, 'position', [44.6+(x*7.957142857142),39.9230769230769-(y*3.06031868138),6,2.3846153846153846]);
 axes(hObject);
...
function setN(a,handles)  
 ...
 axes(handles.axes1);
 imshow(X2);
 set(handles.axes1, 'position', [43.800000000000026,0.23076923076923078+((14-N)*3.06031868138),110.2-((14-N)*7.957142857142),42.38461538461539-((14-N)*3.06031868138)]);
